...
#         stockDayKlineThread = threading.Thread(target=stockDayKlineServiceBatch.processing_security_codes, args=(temp_tuple, calendar_max_the_date, 'batch-' + str(i+1)))
...
# kline_type = 'month'
# stockDeriveKlineServicemonth = StockDeriveKlineService(dbServicemonth, kline_type, logger, sleep_seconds, one_time)
...
# kline_type = 'quarter'
# stockDeriveKlineServicequarter = StockDeriveKlineService(dbServicequarter, kline_type, logger, sleep_seconds, one_time)
...
# kline_type = 'year'
# stockDeriveKlineServiceyear = StockDeriveKlineService(dbServiceyear, kline_type, logger, sleep_seconds, one_time)
