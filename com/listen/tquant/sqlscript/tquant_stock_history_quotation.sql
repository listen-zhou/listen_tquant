CREATE TABLE `tquant_stock_history_quotation` (
	...
	`close_open_chg` DECIMAL(20,2) NULL DEFAULT NULL COMMENT '收盘价与开盘价偏离幅度百分比',
	`price_avg` DECIMAL(20,2) NULL DEFAULT NULL COMMENT '日均价',
	`price_avg_chg` DECIMAL(20,2) NULL DEFAULT NULL COMMENT '日均价涨跌幅百分比',
	`close_price_avg_chg` DECIMAL(20,2) NULL DEFAULT NULL COMMENT '收盘/日均价涨跌幅百分比',
	...
	`close_10_price_avg_chg` DECIMAL(20,2) NULL DEFAULT NULL COMMENT '收盘价/10日均价涨跌幅百分比',
	`price_avg_chg_10_avg` DECIMAL(20,2) NULL DEFAULT NULL COMMENT '10日均价涨跌幅百分比-平均',
	`price_avg_chg_10_avg_diff` DECIMAL(20,2) NULL DEFAULT NULL COMMENT '10日均价涨跌幅百分比-平均-前后差',
