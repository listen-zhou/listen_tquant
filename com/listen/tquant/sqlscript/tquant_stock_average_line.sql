CREATE TABLE `tquant_stock_average_line` (
	...
	`close_avg_chg_avg_diff` DECIMAL(20,2) NULL DEFAULT NULL COMMENT 'ma日均收盘价波动幅度（涨跌幅）均-差',
	...
	`amount_avg_chg_avg_diff` DECIMAL(20,2) NULL DEFAULT NULL COMMENT 'ma日均交易额涨跌幅均-差',
	...
	`vol_avg_chg_avg_diff` DECIMAL(20,2) NULL DEFAULT NULL COMMENT 'ma日均成交量涨跌幅均-差',
	...
	`price_avg_chg_avg_diff` DECIMAL(20,2) NULL DEFAULT NULL COMMENT 'ma日均成交价涨跌幅均-差',
	...
	`amount_flow_chg_avg_diff` DECIMAL(20,2) NULL DEFAULT NULL COMMENT '日金钱流向涨跌幅均-差',
	...
	`vol_flow_chg_avg_diff` DECIMAL(20,2) NULL DEFAULT NULL COMMENT '日成交量流向涨跌幅均-差',
