CREATE TABLE `tquant_stock_average_line` (
	...
	`amount_avg_chg` DECIMAL(20,2) NULL DEFAULT NULL COMMENT 'ma日均交易额变动幅度（涨跌幅）',
	`amount_avg_chg_avg` DECIMAL(20,2) NULL DEFAULT NULL COMMENT 'ma日均交易额变动幅度（涨跌幅）均',
	...
	`vol_avg_chg` DECIMAL(20,2) NULL DEFAULT NULL COMMENT 'ma日均成交量变动幅度（涨跌幅）',
	`vol_avg_chg_avg` DECIMAL(20,2) NULL DEFAULT NULL COMMENT 'ma日均成交量变动幅度（涨跌幅）均',
	...
	`price_avg_chg` DECIMAL(20,2) NULL DEFAULT NULL COMMENT 'ma日均成交价变动幅度（涨跌幅）',
	`price_avg_chg_avg` DECIMAL(20,2) NULL DEFAULT NULL COMMENT 'ma日均成交价变动幅度（涨跌幅）均',
