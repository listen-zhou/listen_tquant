CREATE TABLE `tquant_stock_day_kline` (
	...
	`amount` DECIMAL(20,4) NULL DEFAULT NULL COMMENT '交易额(元)',
	`previous_amount` DECIMAL(20,4) NULL DEFAULT NULL COMMENT '前一日交易额(元)',
	`amount_change_percent` DECIMAL(20,4) NULL DEFAULT NULL COMMENT '交易额波动幅度（涨跌幅）',
	`vol` DECIMAL(20,4) NULL DEFAULT NULL COMMENT '交易量(手)',
	`previous_vol` DECIMAL(20,4) NULL DEFAULT NULL COMMENT '前一日交易量(手)',
	`vol_change_percent` DECIMAL(20,4) NULL DEFAULT NULL COMMENT '交易量波动幅度（涨跌幅）',
	...
	`close_change_percent` DECIMAL(20,4) NULL DEFAULT NULL COMMENT '收盘价波动幅度（涨跌幅）',
